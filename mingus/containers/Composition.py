...
[refMingusContainersSuite Suites]."""
    ...
    def reset(self):
        """Resets the information in this class. Removes the track and composer \
information."""
    ...
    def add_track(self, track):
        """Adds a track to the composition. Raises an !UnexpectedObjectError if the \
argument is not a [refMingusContainersTrack mingus.containers.Track] \
object."""
...
[refMingusContainersTrack container.Track] supports in __add__"""
    ...
    def __add__(self, value):
        """Overloads the + operator for Compositions. Accepts \
[refMingusContainersNote Notes], note strings, \
