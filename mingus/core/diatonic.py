...
def int_to_note(note_int, key):
    """A better implementation of int_to_note found in the [refMingusCoreNotes \
notes] module. This version bears the key in mind and thus creates \
...
in range(0,12)"""
    ...
    if note_int in known_intervals:
        ...
        if note_int - 1 in known_intervals:
            return notes.remove_redundant_accidentals(known_notes[known_intervals.index(note_int
                     - 1)] + '#')
